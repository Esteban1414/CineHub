...
switch ($accion) {
    case "Agregar":
        ...
        $sentenciaSQL = $conexion->prepare("INSERT INTO noticias (titulo, comentario, imagen, noticia, video) VALUES (:titulo, :comentario, :imagen, :noticia, :video);");
    ...
    case "Modificar":
        $sentenciaSQL = $conexion->prepare("UPDATE noticias SET titulo=:titulo, comentario=:comentario, noticia=:noticia, video=:video WHERE id=:id");
        $sentenciaSQL->bindParam(':titulo', $txtTitulo);
        $sentenciaSQL->bindParam(':comentario', $txtComentario);
        $sentenciaSQL->bindParam(':noticia', $noticia);
        $sentenciaSQL->bindParam(':video', $video);
