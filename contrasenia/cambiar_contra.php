    ...
    <div class="container">
        <div class="row justify-content-center pt-5 mt-5 mr-1 ">
            <div class="col-md-4 formulario neon2">
                ...
                <form method="post">
                    <div class="form-group mx-sm-4 pb-1">
                        <button type="sumbit" name="cancelar" class="<?php echo $cancel ?> btn btn-block text-light btn-neon neon fuente">
                            <span id="span1"></span>
                            <span id="span2"></span>
                            <span id="span3"></span>
                            <span id="span4"></span>
...
if (isset($_POST["cancelar"])) {
    if ($cancel == 'codigo_invalido') {
        echo '<script language="javascript">
    document.addEventListener("DOMContentLoaded", function() {
        Swal.fire({
            icon: "error",
            title: "Su código expiró",
            text: "",
            confirmButtonColor: "#28a745",
            confirmButtonText: "OK",
        }).then(function() {
